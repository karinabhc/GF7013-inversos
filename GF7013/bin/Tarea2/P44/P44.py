...
if __name__ == '__main__':
    ...
    # generamos los Nmodels modelos iniciales como muestras de fprior
    m0.m_set = fprior.draw(Ns=m0.Nmodels).T


    m,acceptance_ratios = metropolis_in_parallel_POOL(m0,likelihood_fun=likelihood_fun,
                                                pdf_prior=fprior,
                                                proposal=proposal,
                                                num_MCMC_steps=NumBurnIn +1, #numStepChains,  # nBurnIn = num_MCMC_steps -1
                                                use_log_likelihood=use_log_likelihood
                                                )
